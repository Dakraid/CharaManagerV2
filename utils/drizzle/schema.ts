...
import { bigint, boolean, foreignKey, index, integer, pgTable, pgView, primaryKey, serial, text, timestamp, unique, uniqueIndex, vector } from 'drizzle-orm/pg-core';
...
export const definitionHistory = pgTable(
    'definition_history',
    {
...
export const ratings = pgTable(
    'ratings',
    {
        ...
        aiLastEvaluated: timestamp({ withTimezone: true }).defaultNow(),
        ...
        aiIntroductionScore: integer(),
        aiIntroductionReason: text(),
