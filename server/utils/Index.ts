...
export { charactersRelations, definitionHistoryRelations, definitionsRelations, ratingsRelations, usersRelations, relationsRelations } from '~/utils/drizzle/relations';
