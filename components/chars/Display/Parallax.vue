...
<template>
    <InspiraCardContainer id="target" ref="target" :class="cn('m-0 p-0 h-[596px] transition-transform hover:scale-103')">
        <InspiraCardBody
            class="relative min-h-[60px] min-w-[300px] place-items-center rounded-xl bg-white text-black dark:bg-black dark:text-white glow-border flex flex-col w-80 h-[596px] border-0 p-4 px-4 gap-4">
            ...
            <InspiraCardItem :translate-z="75" class="w-full">
                <CardContent class="Image-Grid w-[256px] mx-auto p-0 z-10 rounded-xl overflow-hidden transition-all">
                    ...
                    <Badge variant="secondary" class="Token-Permanent-Container rounded-xl rounded-tl-none rounded-br-none">
