...
<template>
    <inspiraGlowBorder
        ...
        <Card class="flex w-80 flex-col gap-4 border-0 p-4 px-4 h-[468px]">
            ...
            <CardContent class="z-10 mx-auto overflow-hidden rounded-xl p-0 transition-all Image-Grid w-[256px]">
                <Skeleton v-if="!targetIsVisible" class="rounded-xl Image-Container h-[256px] w-[256px]" />
                <NuxtImg
                    v-else
                    :id="character.etag"
                    :key="character.etag"
                    ...
                    placeholder-class="rounded-xl object-contain h-[256px] w-[256px] bg-muted"
