    ...
    <div class="flex-1 grid grid-cols-[1fr] grid-rows-[min-content_1fr] xl:grid-cols-[1fr_400px] gap-2 max-h-[calc(100vh_-_theme(spacing.16))]">
        ...
        <Transition>
            ...
            <ScrollArea
                ...
                <ClientOnly>
                    <RenderCacheable v-if="appStore.cardSize == 3" class="flex justify-around flex-wrap gap-6 m-4">
                    ...
                    <RenderCacheable v-else-if="appStore.cardSize == 1" class="flex justify-around flex-wrap gap-6 m-4">
                        <LazyCharsDisplaySquare v-for="character in characterStore.characters" :key="character.id" :character="character" />
                    </RenderCacheable>
                    <RenderCacheable v-else class="flex justify-around flex-wrap gap-6 m-4">
